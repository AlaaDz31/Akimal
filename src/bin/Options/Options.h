...
public:
	...
	GameOptions(string, string = "", bool = false, string = "", bool = false);					// Constructor with path - Can enable log_enabled
	GameOptions(string, string, string,
				string, string, string, 
				string = "", bool = false, string = "", bool = false);							// Constructor with complete initialization
};

// Set file path and eventaully log options
inline GameOptions::GameOptions(string _path, string _log_file, bool _log_enabled, string _music_wav, bool _music_enabled)
	: path(_path), log_file(_log_file), log_enabled(_log_enabled), music_wav(_music_wav), music_enabled(_music_enabled)
{
}
...
inline GameOptions::GameOptions(string _path, string _splash_art, string _menu_art,
								...
								string _music_wav, bool _music_enabled)
	...
	music_wav(_music_wav), music_enabled(_music_enabled)
{
}
